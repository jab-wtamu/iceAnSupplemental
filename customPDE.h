...
#include <core/typeDefs.h>
  ...
  // Surface-tension anisotropy constants
  double eps_xy = userInputs.get_model_constant_double("eps_xy");
  double eps_z  = userInputs.get_model_constant_double("eps_z");

  // Vertical / horizontal anisotropy parameter
  ...
  double D_tilde = userInputs.get_model_constant_double("D_tilde");
